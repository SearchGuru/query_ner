...
score, acc = model.evaluate(X_test, Y_test, batch_size=100, show_accuracy=True)

print('Test score:', score)
print('Test accuracy:', acc)

json_model_string = model.to_json()
with open("./query_ner_rnn_lstm_glove_"+str(batch_size)+"."+str(epoch)+"b.json", "wb") as f:
    f.write(json_model_string)
model.save_weights("./query_ner_rnn_lstm_glove_" + str(batch_size) + "." + str(epoch) + "b.h5", overwrite=True)
